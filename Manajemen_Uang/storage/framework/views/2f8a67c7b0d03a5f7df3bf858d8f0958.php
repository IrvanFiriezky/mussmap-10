...
<div class="my-auto relative overflow-x-auto shadow-md min-h-screen bg-purple-950">
    ...
    <div class="mx-auto my-auto w-1/4 h-44 bg-slate-500 rounded-xl">
        <h1 class="text-center text-2xl font-semibold text-white"><?php echo e($data->nama); ?></h1>
        <p>
        <h2 class="text-center text-xl font-light text-white">jumlah uang</h2>
        <h2 class="text-center text-xl font-light text-white"><?php echo e($data->jumlah_uang); ?></h2>
        </p>
        <p>
        <h2 class="text-center text-xl font-light text-white">email</h2>
        <h2 class="text-center text-xl font-light text-white"><?php echo e($data->email); ?></h2>
        </p>
    </div>
</div>
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layout/aplikasi', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\user\Downloads\SKRIPSI\Program_Uang_Saku\Manajemen_Uang\resources\views/uang/show.blade.php ENDPATH**/ ?>